...
import { Container, Typography, Box, Divider, Collapse, IconButton, Link as MuiLink } from "@mui/material";
...
const CollapsibleSection = ({ section, activeId, onSelect, isOpen, onToggle }) => (
  <Box sx={{ mb: 3 }}>
    <Box
      onClick={onToggle}
      sx={{
...
const SectionHeading = ({ children, id, level = "h2" }) => {
  const styles = {
